...
public class PivotSizeOrderedTreeMapActivity extends Activity implements OnCardClickListener {
	...
	private static final CardColor[] COLORS = { CardColor.BLUE, CardColor.BLUE_GREEN, CardColor.DARK_ORANGE,
			...
			CardColor.BLUE_GREEN, CardColor.ORANGE, CardColor.YELLOW };
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mappingView.setPivotType(Pivot.PIVOT_SIZE);
		setRandomValues();
